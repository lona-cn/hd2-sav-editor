...
> 维护增补：以下单布局常量和测试结果属于 2026-09-19 的历史交接，不是当前支持上限。
> 当前同时识别 `060100003eeacea6b8ba0800` / 572088 与 `07010000b687e357bcba0800` / 572092。
> 装备槽位不变；尾部增加 4 字节的业务含义未确定，编辑器原样保留。
> 当前实现与验证以根 README、`hd2-armor-desk/docs/TEST_RECORD.md` 为准，不将旧游戏观察扩张为新布局游戏验收。
