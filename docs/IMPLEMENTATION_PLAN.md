...
> 当前增补：已从单布局扩展为 Observed0106 / Observed0107 精确识别；长度分别为 572088 / 572092，
> 双甲偏移保持不变。正文尾部只保留、不按推测重建。目录 v2 增加 secondary_weapon 类型。
> 本文后续里程碑为初始计划，当前支持范围见根 README，实际验证见 `../hd2-armor-desk/docs/TEST_RECORD.md`。
